...
!function () {
    ...
    t.prototype.setupHandler = function () {
        ...
        offset: function () {
            console.log('>>>innerHeight', this.context.innerHeight());
            console.log('outerHeight', this.adapter.outerHeight());
            console.log('scrollTop', this.element.scrollTop);
            console.log('value >>> ', 809 - this.adapter.outerHeight() + 36);
           // console.log('fuck', this.element.firstChild.offsetHeight())
            //console.log('value >>> ', this.context.innerHeight() - this.adapter.scrollTop - 959 + 455)
    return "botoom-in-view"; // 454 - stop;;;;;; 455 - start
  },
        // offset  - сколько нужно прокрутить отначала что бы началась загрузка
